  ...
  return (
    <div>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        variants={fadeUp}
        className="relative container bg-white pt-12 sm:pt-35"
      >
        <h2 className="text-[#0F3D62] font-medium text-lg sm:text-xl md:text-2xl lg:text-3xl lg:text-start text-center px-5 common-heading">
          Our Latest <span className="text-[#006EFF] font-bold">Recognitions</span>
        </h2>
      </motion.div>
      ...
      <div className="relative w-full bg-white sm:pb-16 overflow-hidden">
        <motion.div
          ...
          viewport={{ once: true }}
          variants={fadeUp}
          className="pt-8 sm:pt-10 w-full mx-auto flex flex-col items-center sm:px-4 md:px-6 lg:px-8 space-y-10"
        >
          {/* Carousel */}
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            variants={fadeUp}
            className="container relative overflow-hidden bg-cover bg-center px-6 sm:px-10 md:px-16 lg:px-[100px] py-10 sm:py-14 md:py-[80px] rounded-[25px] sm:rounded-[30px] lg:rounded-[40px] mx-auto"

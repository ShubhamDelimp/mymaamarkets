    ...
    <section className="bg-white py-10 sm:py-14 md:py-16 px-4 sm:px-6 lg:px-12 xl:px-16">
      <div className="xl:max-w-7xl w-full mx-auto flex flex-col lg:flex-row items-start gap-10">
        ...
        <motion.div
          ...
          className="flex flex-col justify-center items-center text-center lg:justify-start lg:items-start lg:text-start w-full lg:w-[45%]"
        >
        ...
        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full justify-center place-items-center lg:pr-12">
          {[
            { title: "Forex", img: "/images/rectangle129.png" },
            { title: "Metals", img: "/images/rectangle126.png" },
          ].map((card, idx) => (
            <motion.div
              key={idx}
              ...
              viewport={{ once: true, amount: 0.3 }}
              className="bg-[#f7fafc] rounded-3xl p-4 sm:p-6 shadow-md flex flex-col w-full hover:scale-105 transition-transform"
            >
              <div className="text-[#1a3553] text-lg sm:text-xl md:text-2xl font-Outfit font-bold mb-2">
                {card.title}
              </div>
              ...
              <div className="relative rounded-2xl overflow-hidden">
                ...
                <span className="absolute bottom-3 right-3 bg-[#0b3553] text-white rounded-full w-10 h-10 flex items-center justify-center text-xl shadow-lg cursor-pointer">
                  <img
                    src="/images/group1597880849.png"
                    alt=""
                    width="55"
                    height="55"
                  />
      ...
      <div className="xl:max-w-7xl w-full mx-auto flex flex-col lg:flex-row items-start gap-10 mt-10">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="flex md:flex-col items-center lg:items-start justify-start mb-6 md:mb-0 w-full lg:w-auto"
        >
        ...
        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full">
          {[
            { title: "Shares", img: "/images/rectangle131.png" },
            { title: "Indices", img: "/images/4.png" },
            { title: "Crypto", img: "/images/5.png" },
          ].map((card, idx) => (
            <motion.div
              key={idx}
              initial={{ opacity: 0, y: 50 }}

...
const HP:NextPage = () => {
  	return (
    		<div className={styles.hp}>
      			<Image className={styles.isolationModeIcon} width={1920} height={736} sizes="100vw" alt="" src="/images/effe4ce64a17c2509f7644839f3f235a056b9e5a.png"  unoptimized />
      			<div className={styles.hpChild} />
      			<div className={styles.hpItem} />
      			<div className={styles.hpInner} />
      			<div className={styles.groupParent}>
        				<Image className={styles.groupChild} width={1006.1} height={1013.1} sizes="100vw" alt="" src="/images/effe4ce64a17c2509f7644839f3f235a056b9e5a.png"  unoptimized />
        				<div className={styles.groupItem} />
      			</div>
      			<div className={styles.rectangleDiv} />
				{/* public/images/effe4ce64a17c2509f7644839f3f235a056b9e5a.png */}
      			<Image className={styles.groupIcon} width={2163} height={314} sizes="100vw" alt="" src="/images/effe4ce64a17c2509f7644839f3f235a056b9e5a.png"  unoptimized />
      			<div className={styles.wrapperGroup1597880896Parent}>
        				<div className={styles.wrapperGroup1597880896}>
          					<Image className={styles.wrapperGroup1597880896Child} width={1351.2} height={1295.5} sizes="100vw" alt="" src="/images/1d9b7e343e74ec94e1756509295a223fc8fbd958 (1).png"  unoptimized />
        				</div>
        				<div className={styles.groupInner} />
        				<div className={styles.hpGroupChild} />
      			</div>
      			<Image className={styles.hpHpChild} width={150.7} height={77.5} sizes="100vw" alt="" src="/images/1d9b7e343e74ec94e1756509295a223fc8fbd958 (1).png"  unoptimized />
      			<div className={styles.educationHub}>
        				<b>{`Education `}</b>
        				<span className={styles.hub}>Hub</span>
      			</div>
      			<Image className={styles.u7947585315ProfessionalCloseIcon} width={389} height={371} sizes="100vw" alt="" src="/images/1d9b7e343e74ec94e1756509295a223fc8fbd958 (1).png"  unoptimized />
      			...
      			<div className={styles.wrapperFabfab3000ExtremeClo}>
        				<Image className={styles.wrapperGroup1597880896Child} width={960} height={905} sizes="100vw" alt="" src="/images/1d9b7e343e74ec94e1756509295a223fc8fbd958 (1).png"  unoptimized />
      			</div>
      			<div className={styles.hpChild5} />
      			<Image className={styles.rectangleIcon} width={280} height={250} sizes="100vw" alt="" src="/images/1d9b7e343e74ec94e1756509295a223fc8fbd958 (1).png"  unoptimized />
      			<div className={styles.currencyPairs}>{`40+ currency pairs – majors, crosses & exotics`}</div>
      			<Image className={styles.cmcapitaldesignACloseUpShoIcon} width={1420} height={500} sizes="100vw" alt="" src="/images/1d9b7e343e74ec94e1756509295a223fc8fbd958 (1).png"  unoptimized />
      			...
      			<div className={styles.wrapperYidianlingxiAHighTeParent}>
        				<div className={styles.wrapperYidianlingxiAHighTe}>
          					<Image className={styles.yidianlingxiAHighTechDigitIcon} width={1506} height={844} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
        				</div>
      			...
      			<Image className={styles.hpChild7} width={280} height={51.8} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
      			...
      			<div className={styles.youCanTradeContainer}>{`You can trade on major markets across 5 assets classes including `}
        				...
        				<div className={styles.openLiveAccountWrapper}>
          					<b className={styles.openLiveAccount}>Open Live Account</b>
        				</div>
        				<div className={styles.openLiveAccountContainer}>
          					<b className={styles.openLiveAccount}>Open Live Account</b>
        				</div>
        				<div className={styles.openLiveAccountFrame}>
          					<b className={styles.openLiveAccount}>Open Live Account</b>
        				</div>
        				...
        				<Image className={styles.hpChild13} width={280} height={250} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
        				<div className={styles.hpCurrencyPairs}>{`40+ currency pairs – majors, crosses & exotics`}</div>
        				<b className={styles.hpForex}>Forex</b>
        				<Image className={styles.hpChild14} width={55} height={55} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
        				<div className={styles.hpChild15} />
        				<Image className={styles.hpChild16} width={280} height={250} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
        				<div className={styles.currencyPairs2}>{`40+ currency pairs – majors, crosses & exotics`}</div>
        				<b className={styles.hpMetals}>Metals</b>
        				<Image className={styles.hpChild17} width={55} height={55} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
        				<div className={styles.currencyPairs3}>{`40+ currency pairs – majors, crosses & exotics`}</div>
        				<b className={styles.hpIndices}>Indices</b>
        				<Image className={styles.hpChild18} width={55} height={55} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
        				<Image className={styles.hpChild19} width={55} height={55} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
        				<div className={styles.hpChild20} />
        				<div className={styles.hpChild21} />
        				<Image className={styles.chatgptImageSep23202501} width={337} height={337} sizes="100vw" alt="" src="/images/ChatGPT Image Sep 23, 2025, 03_43_51 PM 2.png"  unoptimized />
        				<div className={styles.currencyPairs4}>{`40+ currency pairs – majors, crosses & exotics`}</div>
        				<b className={styles.hpCrypto}>Crypto</b>
        				<Image className={styles.hpChild22} width={55} height={55} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
        				<div className={styles.hpChild23} />
        				<Image className={styles.screenshot20250911At809} width={533} height={851} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
        				...
        				<Image className={styles.fsclogoIcon} width={151} height={66} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
        				<Image className={styles.dccLogo1} width={138} height={58} sizes="100vw" alt="" src="/images/DCC logo 1.svg"  unoptimized />
        				<Image className={styles.hpChild24} width={187} height={93} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
        				<Image className={styles.chatgptImageSep11202508} width={1206.1} height={1048.9} sizes="100vw" alt="" src="/images/ChatGPT Image Sep 11, 2025, 08_52_57 AM 2.png"  unoptimized />
        				<Image className={styles.hpChatgptImageSep11202508} width={459.2} height={490.4} sizes="100vw" alt="" src="/images/ChatGPT Image Sep 11, 2025, 08_52_57 AM 2.png"  unoptimized />
        				...
        				<div className={styles.weUnderstandThatContainer}>We understand that different clients have different needs. Therefore, we offer a wide selection of trusted,
          					...
          					<div className={styles.appLogo}>
            						<Image className={styles.appLogoChild} width={22.9} height={28.1} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					...
          					<div className={styles.hpAppLogo}>
            						<Image className={styles.appLogoItem} width={25.5} height={28.8} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					...
          					<Image className={styles.clipPathGroup} width={138} height={138} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					<div className={styles.mobileAppParent}>
            						...
            						<Image className={styles.groupChild11} width={40.5} height={45} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					</div>
          					<div className={styles.desktopAppParent}>
            						...
            						<Image className={styles.groupChild12} width={40.5} height={45} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					</div>
          					<div className={styles.webPlatformParent}>
            						...
            						<Image className={styles.groupChild13} width={40.5} height={45} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					</div>
          					...
          					<Image className={styles.hpChild25} width={188} height={862} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					<Image className={styles.hpChild26} width={188} height={852} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					...
          					<Image className={styles.delegatesNetworkingDuringCoIcon} width={382} height={402} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					<Image className={styles.speakersAtABusinessSeminarIcon} width={330} height={220} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					<Image className={styles.businessmenAndBusinesswomenIcon} width={330} height={220} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					...
          					<Image className={styles.asianSpeakerWithCasualSuitIcon} width={330} height={220} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					<Image className={styles.smilingMultiethnicBusinesspeIcon} width={330} height={220} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					<Image className={styles.groupOfBusinesspeopleAttendIcon} width={330} height={220} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					<Image className={styles.hpSpeakersAtABusinessSeminarIcon} width={330} height={220} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					<Image className={styles.speakersAtABusinessSeminarIcon2} width={330} height={220} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					...
          					<div className={styles.nexa45321FrontFacingUltraParent}>
            						<Image className={styles.nexa45321FrontFacingUltraIcon} width={1078} height={1078} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					...
          					<div className={styles.hpOpenLiveAccountWrapper}>
            						<b className={styles.openLiveAccount}>Open Live Account</b>
          					</div>
          					...
          					<Image className={styles.stevevandorenAiPoweredRealIcon} width={491} height={315} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					...
          					<Image className={styles.chatgptImageSep16202503} width={986} height={602} sizes="100vw" alt="" src="/images/ChatGPT Image Sep 3, 2025, 02_57_34 PM 3.png"  unoptimized />
          					...
          					<Image className={styles.hpChild51} width={55} height={55} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					<Image className={styles.hpChild52} width={55} height={55} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					<Image className={styles.hpChild53} width={55} height={55} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					<Image className={styles.hpScreenshot20250916At121} width={207} height={121.1} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
          					<Image className={styles.hpChild54} width={189.7} height={95.7} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
            						...
            						<div className={styles.mainDescriptionParent}>
              							...
              							<div className={styles.nameSurnameParent}>
                								...
                								<div className={styles.parent}>
                  									...
                  									<Image className={styles.starIcon} width={27.6} height={26.7} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
                  									<Image className={styles.groupChild16} width={27.6} height={26.7} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
                  									<Image className={styles.groupChild17} width={27.6} height={26.7} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
                  									<Image className={styles.groupChild18} width={27.6} height={26.7} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
                  									<Image className={styles.groupChild19} width={27.6} height={26.7} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
                								</div>
              							</div>
            						</div>
          					</div>
                  									...
                  									<div className={styles.hpAccordionItem}>
                    										<div className={styles.hpAccordionTitle}>
                      											<div className={styles.whatIsTrading}>What markets can I trade on with My MAA Markets?</div>
                        												...
                        												<Image className={styles.hpChild57} width={310.8} height={63.9} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
                        												...
                        												<div className={styles.openLiveAccountWrapper2}>
                          													<b className={styles.openLiveAccount}>Open Live Account</b>
                        												</div>
                        												<Image className={styles.hpIsolationModeIcon} width={1920} height={602} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
                        												<div className={styles.regulatedByFscGloballyContainer}>
                          													...
                          													<p className={styles.toGlobalMarkets}>
                            														...
                            														<a className={styles.wwwmymaamarketscom} href="https://www.mymaamarkets.com/" target="_blank">
                            														...
                            														<Image className={styles.mariiakapYoungBeardedManWIcon} width={391} height={371} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
                            														<div className={styles.hpChild60} />
                            														<b className={styles.hpWebinars}>Webinars</b>
                            														<Image className={styles.hpChild61} width={55} height={55} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
                            														<Image className={styles.hpChild62} width={55} height={55} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
                            														<div className={styles.groupContainer}>
                              															<div className={styles.eurToUsdParent}>
                                																<div className={styles.eurToUsd}>EUR to USD</div>
                                																<div className={styles.div15}>1.05650</div>
                                																<div className={styles.div16}>-0.00265 (-0.25)%</div>
                                																<div className={styles.ellipseDiv} />
                              															</div>
                              															<div className={styles.eurToUsdGroup}>
                                																<div className={styles.eurToUsd}>EUR to USD</div>
                                																<div className={styles.div15}>1.05650</div>
                                																<div className={styles.div16}>-0.00265 (-0.25)%</div>
                                																<div className={styles.ellipseDiv} />
                              															</div>
                              															<div className={styles.eurToUsdContainer}>
                                																<div className={styles.eurToUsd}>EUR to USD</div>
                                																<div className={styles.div15}>1.05650</div>
                                																<div className={styles.div20}>-0.00265 (-0.25)%</div>
                                																<div className={styles.ellipseDiv} />
                              															</div>
                              															<div className={styles.hpEurToUsdParent}>
                                																<div className={styles.eurToUsd}>EUR to USD</div>
                                																<div className={styles.div15}>1.05650</div>
                                																<div className={styles.div20}>-0.00265 (-0.25)%</div>
                                																<div className={styles.ellipseDiv} />
                            														...
                            														<div className={styles.chatgptImageSep23202503Parent}>
                              															<Image className={styles.chatgptImageSep23202503} width={227} height={227} sizes="100vw" alt="" src="/images/ChatGPT Image Sep 23, 2025, 03_43_51 PM 2.png"  unoptimized />
                              															<Image className={styles.hpChatgptImageSep23202503} width={227} height={227} sizes="100vw" alt="" src="/images/ChatGPT Image Sep 23, 2025, 03_43_51 PM 2.png"  unoptimized />
                            														</div>
                            														<Image className={styles.hpChild63} width={51.3} height={51.3} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
                            														<Image className={styles.hpChild64} width={51.3} height={51.3} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
                            														<Image className={styles.hpChild65} width={51.3} height={51.3} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
                            														<Image className={styles.hpChild66} width={51.3} height={51.3} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
                            														<Image className={styles.hpChild67} width={51.1} height={51.1} sizes="100vw" alt="" src="/images/blank.png"  unoptimized />
</div>);
};
